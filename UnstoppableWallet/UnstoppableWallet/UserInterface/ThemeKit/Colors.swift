...
public extension UIColor {
    ...
    static let themeYellowD = UIColor(hex: 0x0084FF)
    static let themeYellowL = UIColor(hex: 0x1249FF)
    ...
    static let themeYellow50 = UIColor(hex: 0x0084FF, alpha: 0.5)
    static let themeYellow20 = UIColor(hex: 0x0084FF, alpha: 0.2)
