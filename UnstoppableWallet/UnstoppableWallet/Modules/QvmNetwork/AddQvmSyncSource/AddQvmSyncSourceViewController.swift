...
class AddQvmSyncSourceViewController: KeyboardAwareViewController {
    private let viewModel: AddQvmSyncSourceViewModel
    ...
    init(viewModel: AddQvmSyncSourceViewModel) {
    ...
    override func viewDidLoad() {
        ...
        title = "add_qvm_sync_source.title".localized
...
extension AddQvmSyncSourceViewController: SectionsDataSource {
    func buildSections() -> [SectionProtocol] {
        [
            ...
            Section(
                id: "url",
                headerState: tableView.sectionHeader(text: "add_qvm_sync_source.rpc_url".localized),
            ...
            Section(
                id: "basic-auth",
                headerState: tableView.sectionHeader(text: "add_qvm_sync_source.basic_auth".localized),
